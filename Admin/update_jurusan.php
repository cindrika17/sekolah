...
<body>
    ...
    <section class="about" id="about">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h2 class="text-center"> Ubah Data Jurusan</h2>
            <?php
              include "c:/xampp/htdocs/Database_Cindri/Login/koneksi.php";
              $id_jurusan = $_GET['id_jurusan'];
              $execute = mysqli_query($koneksi, "SELECT * FROM jurusan where id_jurusan='$id_jurusan'")or die(mysqli_error());
        ...
        <div class="row">
          <div class="row">
            <div class="col-sm-6">
            <form action="update_jurusan_action.php" method="POST">
              <div class="form-group">
                <label>Nama Jurusan</label><br>
                <input type="text" name="nama_jurusan" class="form-control" value="<?= $data["nama_jurusan"]?>"></input><br>
